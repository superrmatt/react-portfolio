        ...
        <Container>
          <Row>
            ...
            <Col size="lg-10 sm-12">
              ...
              <p>
                &nbsp;&nbsp; &nbsp;&nbsp;My programming career started at the age of fifteen, in highschool, when I decided to take a c++ programming course offered through SUNY Albany. I instantly fell in love. I have since pursued a degree in computer science at the University at Buffalo, in 2015 I transferred to SUNY Plattsburgh, in a hope of further honing my CS degree into a computer security degree. In may of 2017 I graduated from SUNY Plattsburgh with a BS in Computer Security, with concentrations in intrusion detection, and cyber threat analysis modeling, with honors.
                <img className="grad" src={grad} alt="Graduation" />
              </p>
              <p>
                {" "}
                &nbsp;&nbsp; &nbsp;&nbsp; In 2019, I decided to pursue a web development based coding bootcamp. The original draw was to vary my skillset from algorithmic, software solutions to add some web solutions as well. As time went on, I learned to love web development, just as I learned to love c++, all those years ago in 2010. I graduated succsessfully in May of 2020, during the COVID-19 pandemic, with a whole host of new tools & technologies at my disposal.
              </p>
            </Col>
          </Row>
        </Container>
